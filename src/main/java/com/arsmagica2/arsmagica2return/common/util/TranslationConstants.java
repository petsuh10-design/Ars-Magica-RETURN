...
public interface TranslationConstants {
    String ALTAR_CORE_LOW_POWER                  = "block."     + ArsMagicaAPI.MOD_ID + ".altar_core.low_power";
    String CRYSTAL_WRENCH_TOO_FAR                = "item."      + ArsMagicaAPI.MOD_ID + ".crystal_wrench.too_far";
    String SPELL_BURNOUT                         = "item."      + ArsMagicaAPI.MOD_ID + ".spell.burnout";
    ...
    String SPELL_RECIPE_AFFINITIES               = "item."      + ArsMagicaAPI.MOD_ID + ".spell_recipe.affinities";
    String SPELL_RECIPE_INGREDIENTS              = "item."      + ArsMagicaAPI.MOD_ID + ".spell_recipe.ingredients";
    String SPELL_RECIPE_INVALID                  = "item."      + ArsMagicaAPI.MOD_ID + ".spell_recipe.invalid";
    String SPELL_RECIPE_INVALID_DESCRIPTION      = "item."      + ArsMagicaAPI.MOD_ID + ".spell_recipe.invalid.description";
    String SPELL_RECIPE_REAGENTS                 = "item."      + ArsMagicaAPI.MOD_ID + ".spell_recipe.reagents";
    String SPELL_RECIPE_SHAPE_GROUP              = "item."      + ArsMagicaAPI.MOD_ID + ".spell_recipe.shape_group";
    ...
    String INSCRIPTION_TABLE_COLOR_PICKER_TITLE  = "screen."    + ArsMagicaAPI.MOD_ID + ".inscription_table.color_picker.title";
    String INSCRIPTION_TABLE_COLOR_PICKER_CANCEL = "screen."    + ArsMagicaAPI.MOD_ID + ".inscription_table.color_picker.cancel";
    String INSCRIPTION_TABLE_COLOR_PICKER_DONE   = "screen."    + ArsMagicaAPI.MOD_ID + ".inscription_table.color_picker.done";
