...
public final class RenderUtil {
     ...
     *
     * @param graphics The gui graphics to draw with.
     ...
     */
    public static void gradientLine2d(GuiGraphics graphics, float startX, float startY, float endX, float endY, int zLevel, int color1, int color2, float width) {
     ...
     * @param color2   The second color, used near the end of the line.
     */
    public static void gradientLine2d(GuiGraphics graphics, float startX, float startY, float endX, float endY, int zLevel, int color1, int color2) {
        gradientLine2d(graphics, startX, startY, endX, endY, zLevel, color1, color2, 1f);
    }
     ...
     * @param width    The width of the line.
     */
    public static void line2d(GuiGraphics graphics, float startX, float startY, float endX, float endY, int zLevel, int color, float width) {
        gradientLine2d(graphics, startX, startY, endX, endY, zLevel, color, color, width);
    }
     ...
     * @param color    The color of the line.
     */
    public static void line2d(GuiGraphics graphics, float startX, float startY, float endX, float endY, int zLevel, int color) {
        line2d(graphics, startX, startY, endX, endY, zLevel, color, 1f);
    }
     ...
     * @param color    The color of the line.
     */
    public static void lineThick2d(GuiGraphics graphics, float startX, float startY, float endX, float endY, int zLevel, int color) {
        line2d(graphics, startX, startY, endX, endY, zLevel, color, 4f);
    }
     ...
     */
    public static void fractalLine2dd(GuiGraphics graphics, double startX, double startY, double endX, double endY, int zLevel, int color, float displace, float fractalDetail) {
        fractalLine2df(graphics, (float) startX, (float) startY, (float) endX, (float) endY, zLevel, color, displace, fractalDetail);
    }
     ...
     * @param fractalDetail The fractal detail to use.
     */
    public static void fractalLine2df(GuiGraphics graphics, float startX, float startY, float endX, float endY, int zLevel, int color, float displace, float fractalDetail) {
        if (displace < fractalDetail) {
            line2d(graphics, startX, startY, endX, endY, zLevel, color);
        } else {
            ...
            fractalLine2df(graphics, startX, startY, mx, my, zLevel, color, displace / 2f, fractalDetail);
            fractalLine2df(graphics, endX, endY, mx, my, zLevel, color, displace / 2f, fractalDetail);
        }
    }
