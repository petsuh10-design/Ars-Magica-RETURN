...
public class PatchouliCompat implements ICompatHandler {
    ...
    private static final String SPELL_PART_TEMPLATE = "{\"components\": [{\"type\": \"patchouli:custom\",\"class\": \"com.arsmagica2.arsmagica2return.compat.patchouli.SpellPartPage\",\"part\": \"#part\"}]}";
