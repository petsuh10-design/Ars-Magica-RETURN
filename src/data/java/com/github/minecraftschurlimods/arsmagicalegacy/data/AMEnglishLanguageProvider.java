...
import com.arsmagica2.arsmagica2return.common.init.AMStats;
...
import com.arsmagica2.arsmagica2return.server.commands.CommandTranslations;
...
class AMEnglishLanguageProvider extends AMLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        skillTranslation(AMSpellParts.ATTRACT.getId(), "Attract", "You go there.", "components", "You create an area of negative pressure, pulling everything but you towards the target position.");
        ...
        skillTranslation(AMSpellParts.COLOR.getId(), "Color", "Rainbow!", "modifiers", "This modifier allows changing the particles of a spell component. Want green fireballs? Have at it!$(br2)The color is determined during spell creation. When adding the modifier, choose the color you want. If you want to change the color, you can do so by right-clicking the modifier again. The color cannot be changed after the spell is crafted!");
        ...
        skillTranslation(AMSpellParts.REPEL.getId(), "Repel", "Go away from me!", "components", "You can create a singularity in space, which, as long as you maintain it, will radiate waves of force, pushing anything but you away from the target position.");
