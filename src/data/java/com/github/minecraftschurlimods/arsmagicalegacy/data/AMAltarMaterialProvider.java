...
import com.arsmagica2.arsmagica2return.api.data.AltarMaterialProvider;
import com.arsmagica2.arsmagica2return.common.init.AMBlocks;
import net.minecraft.data.BlockFamilies;
import net.minecraft.world.level.block.Blocks;

final class AMAltarMaterialProvider {
    static class Structure extends AltarMaterialProvider.Structure {
    ...
    static class Cap extends AltarMaterialProvider.Cap {
