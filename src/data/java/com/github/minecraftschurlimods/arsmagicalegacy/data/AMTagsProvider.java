...
//            tag(BlockTags.MINEABLE_WITH_HOE);
            ...
            tag(BlockTags.SNOW_LAYER_CANNOT_SURVIVE_ON).add(AMBlocks.OBELISK.get(), AMBlocks.CELESTIAL_PRISM.get(), AMBlocks.INSCRIPTION_TABLE.get());
        }
    }
    ...
    static class Items extends ItemTagsProvider {
        ...
        protected void addTags(HolderLookup.Provider lookup) {
            ...
            tag(AMTags.Items.INSCRIPTION_TABLE_BOOKS).add(net.minecraft.world.item.Items.WRITABLE_BOOK);
    ...
    static class Biomes extends BiomeTagsProvider {
        Biomes(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, ExistingFileHelper existingFileHelper) {
